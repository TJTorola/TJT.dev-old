...
export default ({ seconds, playing, reset }) => (
  <svg width="60" height="60" 
    ...
    onClick={ reset } >
    <path
      d="M1664 896q0 156-61 298t-164 245-245 164-298 61q-172
      0-327-72.5t-264-204.5q-7-10-6.5-22.5t8.5-20.5l137-138q10-9 25-9 16 2 23 12 73 95 179
      147t225 52q104 0 198.5-40.5t163.5-109.5 109.5-163.5
